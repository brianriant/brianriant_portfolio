export const posts = [
  ...
  },
  {
    ...
    content:
      "Exploring modern state management techniques using Context API and Zustand. Learn how to manage complex application state while maintaining performance and developer experience.",
