  ...
  return (
    ...
    >
      ...
      >
        ...
        ideas, or opportunities to be part of your vision. Let&apos;s connect
      ...
      >
        ...
        <motion.textarea
          ...
          required
          aria-label="Message"
          className=" w-full p-4 outline-none border border-gray-300 rounded-xl bg-white mb-6 invalid:text-pink-600 focus:border-green-500 focus:outline focus:outline-green-500  focus:invalid:outline-pink-500focus:border-black dark:bg-darkHover/30 dark:border-white/90 dark:text-white/80 "
        ></motion.textarea>
