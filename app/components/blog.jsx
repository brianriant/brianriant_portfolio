        ...
        {blogData.map((blog, index) => (
          <Link href={`/blog/${blog.slug}`}>
            <motion.div
              ...
              key={index}
              className="bg-no-repeat mx-4 bg-cover bg-center relative border shadow-md shadow-green-400 border-gray-400 rounded-lg overflow-hidden cursor-pointer group h-72"
