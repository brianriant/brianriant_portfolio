      ...
      <nav
        ...
        <ul
          ...
          {navLinks.map((link, index) => (
            <li key={index}>
              <a
                href={link.url}
                className="font-Ovo hover:underline hover:text-green-500 hover:decoration-wavy hover:decoration-green-400 hover:decoration-2">
                {link.name}
              </a>
            </li>
          ))}
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className="hidden lg:flex items-center gap-3 px-10 py-2.5 border-2 border-gray-500 rounded-full ml-4 font-Ovo dark:border-white/50 hover:underline hover:text-green-500 hover:decoration-wavy hover:decoration-green-400 hover:decoration-2">
            Contact
            <Image
